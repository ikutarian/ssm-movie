                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body table-responsive no-padding">
                        ...
                        <table class="table table-hover">
                            ...
                            <c:forEach items="${pageInfo.list}" var="movieCol">
                            <tr>
                                <td>${movieCol.id}</td>
                                <td>${movieCol.movie.title}</td>
                                <td>${movieCol.user.name}</td>
                                <td><fmt:formatDate value="${movieCol.addTime}" type="date" pattern="yyyy-MM-dd"/></td>
                                <td>
                                    <a href="${pageContext.request.contextPath}/admin/moviecol/del/${movieCol.id}" class="label label-danger">删除</a>
                                </td>
                            </tr>
                            </c:forEach>
                            </tbody>
