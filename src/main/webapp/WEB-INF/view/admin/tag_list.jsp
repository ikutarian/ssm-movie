            ...
            <div class="col-md-12">
                <div class="box box-primary">
                        ...
                        <table class="table table-hover">
                            ...
                            <c:forEach items="${pageInfo.list}" var="tag">
                                <tr>
                                    <td>${tag.id}</td>
                                    <td>${tag.name}</td>
                                    <td><fmt:formatDate value="${tag.addTime}" type="date" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/admin/tag/edit/${tag.id}" class="label label-success">编辑</a>
                                        &nbsp;
                                        <a href="${pageContext.request.contextPath}/admin/tag/del/${tag.id}" class="label label-danger">删除</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                    ...
                    <div class="box-footer clearfix">
                        <%--<c:import url="/WEB-INF/view/ui/admin_page.jsp"/>--%>
